...
//                 : ""
//             }`}
//             onClick={() => handleDeleteRow(record.key, record.postID)}
//           />
//         </Tooltip>
...
//     if (getReport?.data?.result) {
//       const transformed = getReport.data.result.map((report) => ({
//         key: report._id, // This is the report ID
//         reportID: report._id,
//         postID: report.postId?._id, // This is the post ID
//         postTitle: report.postId?.title || "N/A",
//         author: report.postId?.author?.userName || "N/A",
//         authorId: report.postId?.author?._id || null,
//         reportedBy: report.reporterId?.userName || "N/A",
...
//         const reportToDelete = userData.find((user) => user.key === key);
//         if (reportToDelete) {
//           return deletePost(reportToDelete.postID).unwrap();
//         }
//         return null;
//       });
...
//   const handleDeleteRow = async (reportId, postId) => {
//     try {
//       if (!reportId) {
...
//       if (res.success) {
//         message.success("Post successfully removed");
//         const updatedData = userData.filter((user) => user.key !== reportId);
//         setUserData(updatedData);
//         setFilteredData(updatedData);
//       } else {
...
//       message.error(err.message || "An error occurred while deleting the post");
//     }
//   };
